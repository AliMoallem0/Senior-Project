...
VALUES 
    ('user_suspension_duration', '{"days": 30}', 'Default duration for user suspensions'),
    ('max_login_attempts', '{"count": 5}', 'Maximum number of failed login attempts before account lock'),
    ('session_timeout', '{"minutes": 30}', 'Session timeout duration in minutes')
