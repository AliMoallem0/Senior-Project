...
VALUES 
    ('user_suspension_duration', '{"days": 30}', 'Default duration for user suspensions', '00000000-0000-0000-0000-000000000000'),
    ('max_login_attempts', '{"count": 5}', 'Maximum number of failed login attempts before account lock', '00000000-0000-0000-0000-000000000000'),
    ('session_timeout', '{"minutes": 30}', 'Session timeout duration in minutes', '00000000-0000-0000-0000-000000000000')
